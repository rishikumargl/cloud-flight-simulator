...
export const learningTracks = [
  {
    id: 'compute',
    name: 'Compute',
    description: 'Master Google Cloud compute services',
    icon: '⚙️',
  ...
  },
  {
    id: 'storage',
    name: 'Storage',
    description: 'Learn cloud storage and databases',
    icon: '💾',
...
export const difficulties = [
  { id: 'beginner', name: 'Beginner', level: 1, color: 'bg-green-100 text-green-700' },
  { id: 'intermediate', name: 'Intermediate', level: 2, color: 'bg-yellow-100 text-yellow-700' },
  { id: 'advanced', name: 'Advanced', level: 3, color: 'bg-red-100 text-red-700' },
];
...
export const mockRecentActivities = [
  ...
  },
  {
    ...
    description: 'Beginner level challenge',
...
export const mockEvaluationResults = {
  ...
  evaluation: {
    ...
    mistakes: [
      'Initial bastion host configuration was overly permissive - corrected',
    ],
    improvements: [
